...
class GamePhase:
    ...
    Members:
      ...
      PHASE_END
    """
    PHASE_ATTACK_PLUS: typing.ClassVar[GamePhase]  # value = <GamePhase.PHASE_ATTACK_PLUS: 2>
    PHASE_BUY: typing.ClassVar[GamePhase]  # value = <GamePhase.PHASE_BUY: 8>
    PHASE_DEFENSE: typing.ClassVar[GamePhase]  # value = <GamePhase.PHASE_DEFENSE: 5>
    PHASE_DISCARD: typing.ClassVar[GamePhase]  # value = <GamePhase.PHASE_DISCARD: 11>
    PHASE_END: typing.ClassVar[GamePhase]  # value = <GamePhase.PHASE_END: 12>
    PHASE_EXCHANGE_HP: typing.ClassVar[GamePhase]  # value = <GamePhase.PHASE_EXCHANGE_HP: 9>
    PHASE_EXCHANGE_MP: typing.ClassVar[GamePhase]  # value = <GamePhase.PHASE_EXCHANGE_MP: 10>
    ...
    PHASE_MIRACLE_PLUS: typing.ClassVar[GamePhase]  # value = <GamePhase.PHASE_MIRACLE_PLUS: 3>
    PHASE_SELL: typing.ClassVar[GamePhase]  # value = <GamePhase.PHASE_SELL: 7>
    PHASE_SUPER_MIRROR: typing.ClassVar[GamePhase]  # value = <GamePhase.PHASE_SUPER_MIRROR: 4>
    __members__: typing.ClassVar[dict[str, GamePhase]]  # value = {'PHASE_GUARDIAN': <GamePhase.PHASE_GUARDIAN: 0>, 'PHASE_MAIN': <GamePhase.PHASE_MAIN: 1>, 'PHASE_ATTACK_PLUS': <GamePhase.PHASE_ATTACK_PLUS: 2>, 'PHASE_MIRACLE_PLUS': <GamePhase.PHASE_MIRACLE_PLUS: 3>, 'PHASE_SUPER_MIRROR': <GamePhase.PHASE_SUPER_MIRROR: 4>, 'PHASE_DEFENSE': <GamePhase.PHASE_DEFENSE: 5>, 'PHASE_MIRACLE_DEFENSE': <GamePhase.PHASE_MIRACLE_DEFENSE: 6>, 'PHASE_SELL': <GamePhase.PHASE_SELL: 7>, 'PHASE_BUY': <GamePhase.PHASE_BUY: 8>, 'PHASE_EXCHANGE_HP': <GamePhase.PHASE_EXCHANGE_HP: 9>, 'PHASE_EXCHANGE_MP': <GamePhase.PHASE_EXCHANGE_MP: 10>, 'PHASE_DISCARD': <GamePhase.PHASE_DISCARD: 11>, 'PHASE_END': <GamePhase.PHASE_END: 12>}
    def __eq__(self, other: typing.Any) -> bool:
        ...
    def __getstate__(self) -> int:
        ...
...
PHASE_ATTACK_PLUS: GamePhase  # value = <GamePhase.PHASE_ATTACK_PLUS: 2>
PHASE_BUY: GamePhase  # value = <GamePhase.PHASE_BUY: 8>
PHASE_DEFENSE: GamePhase  # value = <GamePhase.PHASE_DEFENSE: 5>
PHASE_DISCARD: GamePhase  # value = <GamePhase.PHASE_DISCARD: 11>
PHASE_END: GamePhase  # value = <GamePhase.PHASE_END: 12>
PHASE_EXCHANGE_HP: GamePhase  # value = <GamePhase.PHASE_EXCHANGE_HP: 9>
PHASE_EXCHANGE_MP: GamePhase  # value = <GamePhase.PHASE_EXCHANGE_MP: 10>
...
PHASE_MIRACLE_PLUS: GamePhase  # value = <GamePhase.PHASE_MIRACLE_PLUS: 3>
PHASE_SELL: GamePhase  # value = <GamePhase.PHASE_SELL: 7>
PHASE_SUPER_MIRROR: GamePhase  # value = <GamePhase.PHASE_SUPER_MIRROR: 4>
