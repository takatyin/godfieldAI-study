...
class GamePhase:
    ...
    PHASE_BUY: typing.ClassVar[GamePhase]  # value = <GamePhase.PHASE_BUY: 9>
    PHASE_BUY_SELECT_MIRROR: typing.ClassVar[GamePhase]  # value = <GamePhase.PHASE_BUY_SELECT_MIRROR: 10>
    PHASE_DEFENSE: typing.ClassVar[GamePhase]  # value = <GamePhase.PHASE_DEFENSE: 5>
    PHASE_DISCARD: typing.ClassVar[GamePhase]  # value = <GamePhase.PHASE_DISCARD: 14>
    PHASE_END: typing.ClassVar[GamePhase]  # value = <GamePhase.PHASE_END: 15>
    PHASE_EXCHANGE_HP: typing.ClassVar[GamePhase]  # value = <GamePhase.PHASE_EXCHANGE_HP: 12>
    PHASE_EXCHANGE_MP: typing.ClassVar[GamePhase]  # value = <GamePhase.PHASE_EXCHANGE_MP: 13>
    ...
    PHASE_MIRACLE_DEFENSE: typing.ClassVar[GamePhase]  # value = <GamePhase.PHASE_MIRACLE_DEFENSE: 6>
    PHASE_MIRACLE_PLUS: typing.ClassVar[GamePhase]  # value = <GamePhase.PHASE_MIRACLE_PLUS: 4>
    PHASE_SELL_SELECT: typing.ClassVar[GamePhase]  # value = <GamePhase.PHASE_SELL_SELECT: 7>
    PHASE_SELL_SELECT_MIRROR: typing.ClassVar[GamePhase]  # value = <GamePhase.PHASE_SELL_SELECT_MIRROR: 8>
    PHASE_SUNDRY_SELECT_MIRROR: typing.ClassVar[GamePhase]  # value = <GamePhase.PHASE_SUNDRY_SELECT_MIRROR: 11>
    __members__: typing.ClassVar[dict[str, GamePhase]]  # value = {'PHASE_GUARDIAN': <GamePhase.PHASE_GUARDIAN: 0>, 'PHASE_MAIN': <GamePhase.PHASE_MAIN: 1>, 'PHASE_MAIN_TARGET_SELECT': <GamePhase.PHASE_MAIN_TARGET_SELECT: 2>, 'PHASE_ATTACK_PLUS': <GamePhase.PHASE_ATTACK_PLUS: 3>, 'PHASE_MIRACLE_PLUS': <GamePhase.PHASE_MIRACLE_PLUS: 4>, 'PHASE_DEFENSE': <GamePhase.PHASE_DEFENSE: 5>, 'PHASE_MIRACLE_DEFENSE': <GamePhase.PHASE_MIRACLE_DEFENSE: 6>, 'PHASE_SELL_SELECT': <GamePhase.PHASE_SELL_SELECT: 7>, 'PHASE_SELL_SELECT_MIRROR': <GamePhase.PHASE_SELL_SELECT_MIRROR: 8>, 'PHASE_BUY_SELECT_MIRROR': <GamePhase.PHASE_BUY_SELECT_MIRROR: 10>, 'PHASE_SUNDRY_SELECT_MIRROR': <GamePhase.PHASE_SUNDRY_SELECT_MIRROR: 11>, 'PHASE_BUY': <GamePhase.PHASE_BUY: 9>, 'PHASE_EXCHANGE_HP': <GamePhase.PHASE_EXCHANGE_HP: 12>, 'PHASE_EXCHANGE_MP': <GamePhase.PHASE_EXCHANGE_MP: 13>, 'PHASE_DISCARD': <GamePhase.PHASE_DISCARD: 14>, 'PHASE_END': <GamePhase.PHASE_END: 15>}
    def __eq__(self, other: typing.Any) -> bool:
        ...
    def __getstate__(self) -> int:
        ...
...
PHASE_BUY: GamePhase  # value = <GamePhase.PHASE_BUY: 9>
PHASE_BUY_SELECT_MIRROR: GamePhase  # value = <GamePhase.PHASE_BUY_SELECT_MIRROR: 10>
PHASE_DEFENSE: GamePhase  # value = <GamePhase.PHASE_DEFENSE: 5>
PHASE_DISCARD: GamePhase  # value = <GamePhase.PHASE_DISCARD: 14>
PHASE_END: GamePhase  # value = <GamePhase.PHASE_END: 15>
PHASE_EXCHANGE_HP: GamePhase  # value = <GamePhase.PHASE_EXCHANGE_HP: 12>
PHASE_EXCHANGE_MP: GamePhase  # value = <GamePhase.PHASE_EXCHANGE_MP: 13>
...
PHASE_MIRACLE_DEFENSE: GamePhase  # value = <GamePhase.PHASE_MIRACLE_DEFENSE: 6>
PHASE_MIRACLE_PLUS: GamePhase  # value = <GamePhase.PHASE_MIRACLE_PLUS: 4>
PHASE_SELL_SELECT: GamePhase  # value = <GamePhase.PHASE_SELL_SELECT: 7>
PHASE_SELL_SELECT_MIRROR: GamePhase  # value = <GamePhase.PHASE_SELL_SELECT_MIRROR: 8>
PHASE_SUNDRY_SELECT_MIRROR: GamePhase  # value = <GamePhase.PHASE_SUNDRY_SELECT_MIRROR: 11>
