...
class EnvPool:
    ...
    def get_observations(self) -> numpy.typing.NDArray[numpy.float32]:
        ...
    def get_observations_for(self, player_id) -> numpy.typing.NDArray[numpy.float32]:
        ...
        "player_idに対応した環境を返す"
    def get_player_stats(self) -> numpy.typing.NDArray[numpy.int32]:
        ...
        """
    def get_true_hands(self, player_id) -> numpy.typing.NDArray[numpy.int32]:
        ...
    def get_opponent_true_hands(self, player_id: int) -> numpy.typing.NDArray[numpy.int32]:
        ...
...
class EventType:
    ...
    REVIVE: typing.ClassVar[EventType]  # value = <EventType.REVIVE: 29>
...
def get_single_legal_action(arg0: InternalState) -> int:
    ...
    """
def get_spiritual_zero_mp_cards() -> list[int]:
    """
    精霊系（直前の奇跡の消費MPを0にする）カードID一覧。テストが全種を網羅するために公開しています。
    """
...
REVIVE: EventType  # value = <EventType.REVIVE: 29>
